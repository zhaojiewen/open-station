...
type BillRepository interface {
	...
	ListByStatus(ctx context.Context, status string, page, pageSize int) ([]entity.Bill, int64, error)
	ListByType(ctx context.Context, billType string, page, pageSize int) ([]entity.Bill, int64, error)
	...
	MarkPartialPaid(ctx context.Context, id uuid.UUID, remainingAmount decimal.Decimal) error
}